...
export const PulseBeams = () => {
  return (
    <div className="relative flex h-[40rem] items-center justify-center overflow-hidden antialiased">
      <button className="group relative z-40 inline-block  cursor-pointer rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 text-white no-underline  shadow-2xl shadow-zinc-900">
        ...
        <div className="relative z-10 flex items-center justify-center  space-x-2 rounded-full bg-zinc-950 px-4 py-0.5 text-center ring-1 ring-white/10 ">
          <span className="inline-block bg-gradient-to-r from-neutral-300 via-neutral-600 to-neutral-300 bg-clip-text text-base text-transparent md:text-xl">
            Explore the MVP
          </span>
        </div>
      </button>
